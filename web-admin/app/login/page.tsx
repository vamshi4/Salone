...
export default function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#F4F6F8] flex items-center justify-center p-4">
      {/* `end-4`, not `right-4`, so the control mirrors to the left in the
          RTL locales (ar, fa, ur) the way a utility control should. */}
