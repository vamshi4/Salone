...
class BookingActionCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      decoration: cardDecoration(borderColor: AppColors.accent),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Row(
          ...
          if (_isCustomerReschedule && proposedSlot != null) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                  color: const Color(0xFFFFF4DD), borderRadius: BorderRadius.circular(AppRadius.sm)),
              child: Text(t.customerRequestedTime(formatDateTime(proposedSlot)),
                  style: const TextStyle(color: Color(0xFF9B6410), fontWeight: FontWeight.w700, fontSize: 12)),
            ),
