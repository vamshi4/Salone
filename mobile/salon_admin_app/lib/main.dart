      ...
      body: SafeArea(
        child: ListView(
          ...
          children: [
            ...
            const Icon(Icons.storefront, size: 46, color: Color(0xFF00796B)),
            const SizedBox(height: 18),
            Text(
              _signupMode ? 'Create salon account' : 'Salon owner login',
            ...
            Text(
              _signupMode
                  ? 'Create your salon first, then we will take you inside.'
                  : 'Use the phone number registered for this salon.',
              textAlign: TextAlign.center,
            ...
            FilledButton.icon(
              ...
              onPressed: _loading ? null : (_signupMode ? _signup : _login),
              icon: _loading
                  ? const SizedBox(
                      width: 18,
                      height: 18,
              ...
              label: Text(
                _loading
                    ? (_signupMode ? 'Creating...' : 'Signing in...')
