...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get inProgressLabel => 'В процессе';

  @override
  String get startBookingButton => 'Начать';

  @override
  String get doneBookingButton => 'Готово';

  @override
  String get todayScheduleHeading => 'Расписание на сегодня';
  ...
  @override
  String get rebookAction => 'Забронировать снова';
  ...
  String get couldNotSaveNotes =>
      'Не удалось сохранить заметки. Попробуйте снова.';

  @override
  String get statsVisitsLabel => 'Визиты';

  @override
  String get statsTotalSpentLabel => 'Всего потрачено';

  @override
  String lastServiceSummary(String service, String date) {
    return 'Последний: $service, $date';
  }
  ...
  @override
  String get notesHint => 'Предпочтения, аллергии, всё, что стоит запомнить';
  ...
  @override
  String get saveNotesButton => 'Сохранить заметки';

  @override
  String get visitHistoryHeading => 'История визитов';

  @override
  String get noVisitsYet => 'Пока нет визитов';

  @override
  String get viewProfileTooltip => 'Посмотреть профиль';

  @override
  String get dailyRevenueGoalLabel => 'Дневная цель по выручке';

  @override
  String get dailyRevenueGoalHint =>
      'Необязательно — оставьте пустым, чтобы скрыть индикатор прогресса на главной';

  @override
  String get payoutsTooltip => 'Выплаты';

  @override
  String get staffActiveLabel => 'Активен';

  @override
  String get canCancelBookingLabel => 'Может отменять записи';

  @override
  String get couldNotLoadPayouts => 'Не удалось загрузить выплаты';

  @override
  String get payoutSettled => 'Выплата зафиксирована';

  @override
  String get couldNotMarkPaid =>
      'Не удалось отметить как оплаченное. Попробуйте снова.';

  @override
  String get payoutsTitle => 'Доходы и выплаты';

  @override
  String get unpaidLabel => 'Не выплачено';

  @override
  String get markAsPaidButton => 'Отметить как оплаченное';

  @override
  String get grossRevenueLabel => 'Выручка';

  @override
  String get totalPayoutLabel => 'Выплата';

  @override
  String get payoutHistoryHeading => 'История выплат';

  @override
  String get noPayoutsYet => 'Пока нет выплат';

  @override
  String get payTypeLabel => 'Тип оплаты';

  @override
  String get payTypeCommission => 'Комиссия';

  @override
  String get payTypeSalary => 'Оклад';

  @override
  String get payTypeBoth => 'Оба';

  @override
  String get commissionRateLabel => 'Комиссия %';

  @override
  String get monthlySalaryLabel => 'Ежемесячный оклад';

  @override
  String get couldNotSavePayType =>
      'Не удалось сохранить настройки оплаты. Попробуйте снова.';

  @override
  String get salaryThisMonthLabel => 'Оклад за этот месяц';

  @override
  String get salaryPaidStatus => 'Выплачено';

  @override
  String get paySalaryButton => 'Выплатить оклад';

  @override
  String get salaryPaid => 'Оклад выплачен';

  @override
  String get couldNotPaySalary =>
      'Не удалось выплатить оклад. Попробуйте снова.';

  @override
  String get searchStaffHint => 'Поиск сотрудников';

  @override
  String get filterActiveStaff => 'Активные';

  @override
  String get filterInactiveStaff => 'Неактивные';

  @override
  String get switchBranchTitle => 'Сменить филиал';

  @override
  String get switchLabel => 'Сменить филиал';

  @override
  String get allBranchesLabel => 'Все филиалы';

  @override
  String get allBranchesSubtitle => 'Общие итоги по всем филиалам';

  @override
  String get pickBranchFirst => 'Сначала выберите конкретный филиал';

  @override
  String branchStatsLine(int count, String revenue, int staff) {
    return '$count записей · $revenue · $staff сотрудников';
  }
  ...
  @override
  String get addBranchButton => 'Добавить филиал';

  @override
  String get addBranchTitle => 'Добавить филиал';

  @override
  String get branchNameAddressRequired =>
      'Название и адрес филиала обязательны';

  @override
  String get couldNotAddBranch =>
      'Не удалось добавить филиал. Попробуйте снова.';

  @override
  String get fillProductFields => 'Заполните все поля товара корректно';
  ...
  @override
  String get skuLabel => 'Артикул (необязательно)';

  @override
  String get stockQtyLabel => 'Остаток';

  @override
  String get lowStockThresholdLabel => 'Низкий остаток при';

  @override
  String get deleteProductButton => 'Удалить товар';
  ...
  @override
  String get filterLowStock => 'Низкий остаток';

  @override
  String get noLowStockProducts => 'Нет товаров с низким остатком';

  @override
  String get noProductsInCatalog => 'Пока нет товаров';
  ...
  String stockCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count в наличии',
      many: '$count в наличии',
      few: '$count в наличии',
      one: '1 в наличии',
    );
    return '$_temp0';
  ...
  @override
  String get lowStockLabel => 'Низкий остаток';
  ...
  String lowStockCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count товара с низким остатком',
      many: '$count товаров с низким остатком',
      few: '$count товара с низким остатком',
      one: '1 товар с низким остатком',
    );
    return '$_temp0';
  }

  @override
  String get morningBriefingHeading => 'Сегодня';
  ...
  String todaysAppointmentsCount(int count) {
    String _temp0 = intl.Intl.pluralLogic(
      count,
      locale: localeName,
      other: '$count визита записано',
      many: '$count визитов записано',
      few: '$count визита записано',
      one: '1 визит записан',
      zero: 'Пока нет записанных визитов',
    );
    return '$_temp0';
  }
  ...
  String revenueGoalPace(String current, String goal) {
    return '$current из цели $goal';
  }

  @override
  String get worthReachingOutHeading => 'Стоит связаться сегодня';

  @override
  String get exportCsvTooltip => 'Экспорт CSV';

  @override
  String get couldNotExportEarnings =>
      'Не удалось экспортировать доходы. Попробуйте снова.';
  ...
  String overdueDaysCount(int days) {
    String _temp0 = intl.Intl.pluralLogic(
      days,
      locale: localeName,
      other: 'просрочка $days дня',
      many: 'просрочка $days дней',
      few: 'просрочка $days дня',
      one: 'просрочка 1 день',
    );
    return '$_temp0';
  }
  ...
  @override
  String get bookingLinkSectionTitle => 'Ссылка для записи';

  @override
  String get bookingLinkSectionSubtitle =>
      'Поделитесь этой ссылкой или QR-кодом, чтобы клиенты могли записаться онлайн';

  @override
  String get copyLinkButton => 'Копировать';

  @override
  String get shareLinkButton => 'Поделиться';
  ...
  String bookingLinkShareText(String salonName, String link) {
    return 'Запись в $salonName: $link';
  }
}
